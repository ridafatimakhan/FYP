...
<div class="content ip-content">
 ...
 Progress Monitoring in Interactive Learning</h4>
<?php				
include('top.html');?>		


<?php $totalConcepts = $clearConcepts = $remaing = 0;

$totalConcepts = gettotcourseconcepts($courseID);
$clearConcepts = getclearedconcepts($courseID,$userID);
$remaing = abs($totalConcepts - $clearConcepts);
...
<script>
var xValues = ["Total", "Clear", "Remaning"];
var yValues = [<?php echo $totalConcepts; ?>, <?php echo $clearConcepts; ?>, <?php echo $remaing; ?>];
